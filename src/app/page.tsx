    ...
    return (
        <LoadedContainer id="skip-nav">
            <section className="flex flex-col items-center justify-center h-screen">
                ...
                <TC className="absolute bottom-0 right-6 transform-gpu w-[calc(100%-3rem)] md:w-[600px] 2xl:w-[900px] h-[calc(100%-3rem)] md:h-[600px] 2xl:h-[900px] opacity-20 dark:opacity-10 stroke-slate-400 dark:stroke-custom-green" />
            </section>
        </LoadedContainer>
    )
}
